...
const MenuItems = ({ e, sx, iconSx }) => (
  <ButtonBase sx={sx} className="d-block ta-l br-15 py-1">
    <Stack
    ...
    >
      <IconButton
        component="span"
        sx={{ color: 'grey.700', bgcolor: 'grey.100', opacity: '0.7', ...iconSx }}
        size="large"
      >
        <Iconify icon={e.icon} />
      </IconButton>
      <Stack>
        ...
        <Typography variant="subtitle1" color="inherit" sx={{ opacity: 0.6 }}>
          {e.subtitle}
        </Typography>
      </Stack>
    </Stack>
