  ...
  return (
    <Page title={product?.title || ''}>
      <Container maxWidth="xl" className="product" sx={{ mb: 8, pt: 2 }}>
        ...
        <Box className="mt-3">
          <Typography variant="font3">{product.title}</Typography>
        </Box>
        ...
        <Stack direction="row" className="jc-sb ai-c my-3">
          ...
          <Stack direction="row" className="ai-c " spacing={1}>
            ...
            /> */}
            <Chip label={product.categoryLabel} size="small" color="success" variant="soft" />
          </Stack>
        </Stack>
        ...
        <Box className="my-4">
          ...
          <Box className="mt-3">
            ...
            <Typography variant="font6" component="div" sx={{ lineHeight: 1.4, opacity: 0.8 }}>
              The contents of this app/website are for infomational purposes only and are not intended to be a
              substitute for professional medical advice, Diagnosis, Treatment, or prevention of a dieseae or medical
        ...
        <SimilarProducts id={product.id} admin={admin} />

        <ProductAction {...product} admin={admin} />
      </Container>
    </Page>
  );
}
